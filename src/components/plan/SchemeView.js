...
import { allAgents } from '../../services/agents/AgentService';
            ...
            <div className='container'>
                <div className='row align-items-center justify-content-center'>
                    <div className='col-6'>
                        ...
                        <div className='text-dark fw-bold'>Required Documents
                    ...
                    <div className='col-6  text-center'>
                        <img src={"http://localhost:8081/monosurance/download?file=" + image} alt="scheme image " className='img-fluid shadow-lg' style={{
                            height: "20rem",
                            width: "20rem"
                        }}></img>
                    </div>
                                                        ...
                                                        <div class="col">
                                                            <div>
                                                                <div class="mb-3 d-flex">
                                                                    ...
                                                                    />
                                                                    <button type='button' className='btn  btn-outline-primary fw-bold' onClick={() => uploadHandler(doc)}>Upload</button>
